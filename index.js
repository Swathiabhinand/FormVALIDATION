...
function checkemail(email)
{
    ...
    { document.getElementById("email").classList.add("success");
        ...
        document.getElementById("email_error").innerText="Email must be 8 letters long and it should include @gmail";
    }
}
...
function checkpassword(password)
{
    ...
    { document.getElementById("password").classList.add("success");
        ...
        document.getElementById("password_error").innerText="Password must be 8 letters long and it should include .";
    }
}
